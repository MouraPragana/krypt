    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-96 w-fulk flex flex-col justify-start items-center blue-glassmorphism">
            <Input placeholder="Address To" name="addressTo" type="text" handleChance={() => { }} />
            <Input placeholder="Amount (ETH)" name="amount" type="number" handleChance={() => { }} />
            <Input placeholder="Keyword (GIF)" name="keyword" type="text" handleChance={() => { }} />
            <Input placeholder="Enter Message" name="message" type="text" handleChance={() => { }} />
